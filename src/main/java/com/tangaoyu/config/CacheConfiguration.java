...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("JHipsterStudy");
        ...
        config.getMapConfigs().put("com.tangaoyu.domain.*", initializeDomainMapConfig(jHipsterProperties));
